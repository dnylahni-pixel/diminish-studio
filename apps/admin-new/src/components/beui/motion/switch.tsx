"use client";
// Adapted from beui.dev/components/motion/switch (token mapping: shadcn roles -> Appica roles).
      ...
      <span className={cn("inline-flex items-center gap-3", className)}>
        <motion.button
          ...
          className={cn(
            ...
            checked ? "justify-end bg-primary" : "justify-start bg-foreground-muted/50",
          )}
        >
          <motion.div
            ref={thumbRef}
