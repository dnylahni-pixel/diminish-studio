"use client";
// Adapted from beui.dev/components/motion/animated-badge (token mapping: shadcn roles -> Appica roles).
...
const STATUS_CLASS: Record<AnimatedBadgeStatus, string> = {
  neutral: "border-border bg-background-muted text-foreground-muted",
