...
export const getGetConfigBootstrapUrl = () => {




  return `/api/config/bootstrap`
}

/**
 * Returns the in-memory runtime config snapshot (version + effective settings) for client bootstrapping
 * @summary Get runtime bootstrap configuration
 */
export const getConfigBootstrap = async ( options?: RequestInit): Promise<ConfigBootstrap> => {

  return customFetch<ConfigBootstrap>(getGetConfigBootstrapUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetConfigBootstrapQueryKey = () => {
    return [
...
export const getGetConfigBootstrapQueryOptions = <TData = Awaited<ReturnType<typeof getConfigBootstrap>>, TError = ErrorType<InternalServerErrorResponse>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getConfigBootstrap>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetConfigBootstrapQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getConfigBootstrap>>> = ({ signal }) => getConfigBootstrap({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getConfigBootstrap>>, TError, TData> & { queryKey: QueryKey }
}

export type GetConfigBootstrapQueryResult = NonNullable<Awaited<ReturnType<typeof getConfigBootstrap>>>
export type GetConfigBootstrapQueryError = ErrorType<InternalServerErrorResponse>
...
export function useGetConfigBootstrap<TData = Awaited<ReturnType<typeof getConfigBootstrap>>, TError = ErrorType<InternalServerErrorResponse>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getConfigBootstrap>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetConfigBootstrapQueryOptions(options)
